...
public class TumblingCategory extends CreateRecipeCategory<TumblingRecipe> {
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, TumblingRecipe recipe, IFocusGroup focuses) {
    ...
    @Override
    public void draw(TumblingRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics gui, double mouseX, double mouseY) {
