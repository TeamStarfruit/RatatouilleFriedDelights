...
public class ContinuousFryerItemHandler implements IItemHandler{
    private ContinuousFryerBlockEntity blockEntity;
    private Direction side;

    public ContinuousFryerItemHandler(ContinuousFryerBlockEntity be, Direction side) {
        this.blockEntity = be;
        this.side = side;
    }
