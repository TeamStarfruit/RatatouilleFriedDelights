...
import org.starfruit.ratatouillefrieddelights.data.recipe.api.TumblingRecipeGen;
...
public class RFDTumblingRecipeGen extends TumblingRecipeGen {
    ...
    GeneratedRecipe
            ...
            PASTA42 = this.create(
                    ...
                    b -> b
                            ...
                            .require(RFDTags.RFDItemTags.CONCRETES.tag)
...
//                    () -> Blocks.OXIDIZED_CHISELED_COPPER))
    ...
    public RFDTumblingRecipeGen(PackOutput output) {
